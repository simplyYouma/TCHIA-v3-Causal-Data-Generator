...
class CausalCoherentGenerator:
    ...
    def _calculate_coherent_yield(
        ...
        base_hi = {
            "mil": 0.28,       # CORRIGÉ : Dans tolérances 0.18-0.40
            "sorgho": 0.32,    # CORRIGÉ : Dans tolérances 0.23-0.50  
            "maïs": 0.46,      # CORRIGÉ : Dans tolérances 0.38-0.60
            "coton": 0.22,     # CORRIGÉ : Dans tolérances 0.13-0.30
            "riz": 0.48        # CORRIGÉ : Dans tolérances 0.43-0.60
        }
