...
class CausalCoherenceTests:
    ...
    def test_scenario_consistency(row: pd.Series) -> Tuple[bool, str, str]:
        ...
        expected_ranges = {
            "exceptional": {"stress": (0, 0.8), "loss": (0, 18)},      # ÉLARGI
            "good": {"stress": (0.2, 1.5), "loss": (8, 35)},           # ÉLARGI  
            "average": {"stress": (0.4, 2.5), "loss": (20, 55)},       # ÉLARGI
            "difficult": {"stress": (0.8, 3.5), "loss": (35, 75)},     # ÉLARGI
            "catastrophic": {"stress": (1.5, 7.0), "loss": (60, 95)}   # ÉLARGI
        }
