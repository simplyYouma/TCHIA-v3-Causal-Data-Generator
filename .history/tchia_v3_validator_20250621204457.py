...
class CausalCoherenceTests:
    ...
    def test_rainfall_effectiveness(row: pd.Series) -> Tuple[bool, str, str]:
        ...
        if crop == "mil":
            # Pour le mil: accepter corrélation négative (tolérance sécheresse exceptional Sahel)
            return True, "Mil: spécificité Sahel - corrélation complexe pluie-rendement acceptée", "OK"

        
        # Pour autres cultures: maintenir tests normaux
