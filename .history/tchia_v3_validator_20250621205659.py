...
expected_ranges = {
    "exceptional": {"stress": (0, 1.2), "loss": (0, 25)},
    "good": {"stress": (0.3, 2.0), "loss": (10, 40)}, 
    "average": {"stress": (0.6, 3.2), "loss": (25, 60)},
    "difficult": {"stress": (1.2, 4.5), "loss": (40, 80)},
    "catastrophic": {"stress": (2.0, 8.0), "loss": (65, 95)}
}
