...
class RealDistributions:
    ...
    YIELD_DISTRIBUTIONS = {
        # 🔧 CORRECTION : Rendements ajustés selon données Mali réelles
        "mil": {"mean": 650, "std": 200, "min": 200, "max": 1200},      # Au lieu de 865
        "sorgho": {"mean": 750, "std": 250, "min": 300, "max": 1500},   # Au lieu de 1000
        "maïs": {"mean": 1500, "std": 500, "min": 500, "max": 3500},    # Au lieu de 1800
        "coton": {"mean": 900, "std": 250, "min": 400, "max": 1800},    # Au lieu de 1100
        "riz": {"mean": 2200, "std": 700, "min": 800, "max": 4500}     # Au lieu de 2500
    }
